...
const lyricsData: Record<number, Array<{ time: number; text: string }>> = {
  ...
  6: [ // Ma f'ayo fo by Bode Nathaniel
    { time: 0, text: "" },
    { time: 5, text: "O ra moto, o ti kole" },
    { time: 10, text: "O lo ngapa, ma f'ayo fo" },
    { time: 15, text: "O ti yo tan, o tun lowa" },
    { time: 20, text: "Bekun bekun, ma f'ayo fo" },
    { time: 25, text: "Ki lo nse e, t'o fi nronu" },
    { time: 30, text: "Se'wo ko ni, o f'ayo fo" },
    { time: 35, text: "Ise k'use iso k'uso" },
    { time: 40, text: "Solo makinde o f'ayo fo" },
    { time: 45, text: "" },
    { time: 50, text: "Ma f'ayo fo, ma f'ayo fo" },
    { time: 55, text: "Oremi ma f'ayo fo" },
    { time: 60, text: "" },
    { time: 65, text: "O ti l'owo oti hammer" },
    { time: 70, text: "Better calm your skin" },
    { time: 75, text: "K'omafayo fo" },
    { time: 80, text: "O ti yo tan, o tun lowa" },
    { time: 85, text: "Bekun bekun, m'afayo fo" },
    { time: 90, text: "Jagun labi, alagidi" },
    { time: 95, text: "Alakori, o f'ayo fo" },
    { time: 100, text: "Imu kumu, ije kuje" },
    { time: 105, text: "Mo nkilo fun e, ma fayo fo" },
    { time: 110, text: "" },
    { time: 115, text: "Ma f'ayo fo, ma f'ayo fo" },
    { time: 120, text: "Oremi ma f'ayo fo" },
    { time: 125, text: "" },
    { time: 130, text: "Bijo bawa l'ese re ma l'o sun" },
    { time: 135, text: "ko wa ba mi jo, awon ota gbogbo won ti sun" },
    { time: 140, text: "ko wa ba mi jo" },
    { time: 145, text: "" },
    { time: 150, text: "Bijo bawa l'ese re sa ma mi" },
    { time: 155, text: "ko wa ba mi jo, awon ota gbogbo won ti sun" },
    { time: 160, text: "ko wa ba mi jo" },
    { time: 165, text: "" },
    { time: 170, text: "Rora ma mi, ijo tiya jupa jupa" },
    { time: 180, text: "" }
  ],
  7: [ // You Make Me Better by Bode Nathaniel
    { time: 0, text: "" },
    { time: 5, text: "I dey go my way" },
    { time: 10, text: "I don't care what they say" },
    { time: 15, text: "I already told you, baby mi" },
    { time: 20, text: "I am here to stay" },
    { time: 25, text: "Baby mi o, olomi o" },
    { time: 30, text: "I just wanna love you" },
    { time: 33, text: "let me love you" },
    { time: 36, text: "Baby mi o olomi o" },
    { time: 40, text: "I just wanna love you" },
    { time: 45, text: "Cuz when I'm with you girl," },
    { time: 50, text: "You make me better" },
    { time: 53, text: "You make me better" },
    { time: 56, text: "You make me better" },
    { time: 59, text: "You make me better" },
    { time: 65, text: "" },
    { time: 70, text: "I think I'm ready now" },
    { time: 75, text: "we should just settle down" },
    { time: 80, text: "I really need you" },
    { time: 83, text: "& I won't let you down" },
    { time: 88, text: "So today I pray" },
    { time: 92, text: "that we find a way" },
    { time: 96, text: "b'ose l'owuro or asale" },
    { time: 100, text: "Love always finds a way" },
    { time: 105, text: "Baby mi o, olomi o" },
    { time: 110, text: "I just wanna love you" },
    { time: 113, text: "let me love you" },
    { time: 116, text: "Baby mi o olomi o" },
    { time: 120, text: "I just wanna love you" },
    { time: 125, text: "Cuz when I'm with you girl," },
    { time: 130, text: "You make me better" },
    { time: 133, text: "You make me better" },
    { time: 136, text: "You make me better" },
    { time: 139, text: "You make me better" },
    { time: 145, text: "" }
  ],
  8: [ // Life
    { time: 5, text: "I can't tell you I'm sorry....." },
    { time: 15, text: "Hey, If you've got something to say, talk am to my face" },
    { time: 20, text: "Be like say you want pie on top of my case" },
    { time: 25, text: "Me & you we no follow run the same race" },
    { time: 30, text: "I dey my race, my race" },
    { time: 35, text: "Won fe jo mi sun won le to" },
    { time: 40, text: "Now won fe bami ya photo" },
    { time: 45, text: "I can't tell you that I'm sorry" },
    { time: 50, text: "I don't pressure anybody" },
    { time: 55, text: "I wan dey my day, enjoy & flext my life" },
    { time: 65, text: "Life no get two part" },
    { time: 70, text: "just take your time & live your life" },
    { time: 75, text: "Cuz if you die today my guy we go cry one time" },
    { time: 80, text: "but we go dey alright (everybody go dey alright)" },
    { time: 95, text: "Said she only wanna have fun" },
    { time: 100, text: "Tell me say she want no love" },
    { time: 105, text: "woke up in the morning she gone" },
    { time: 110, text: "oh God she gone gone" },
    { time: 115, text: "Bad man got no time" },
    { time: 120, text: "Got another shorty in mind" },
    { time: 125, text: "hit up on the homies one time" },
    { time: 130, text: "said we gonna party tonight night" },
    { time: 140, text: "Life no get two part" },
    { time: 145, text: "just take your time & live your life" },
    { time: 150, text: "cuz if you die today my guy we go cry one time" },
    { time: 155, text: "but we go dey alright (everybody go dey alright)" },
    { time: 170, text: "" }
  ],
  9: [ // Ìsinmi feat. Franc White
    { time: 5, text: "Olorun mi Elededa mi" },
    { time: 10, text: "Wafi Isinmi f'okan mi" },
    { time: 15, text: "Mofe ki okan mi bale" },
    { time: 20, text: "F'oyin a'tadun s'aiye me" },
    { time: 25, text: "Olorun mi Elededa mi" },
    { time: 30, text: "Wafi Isinmi f'okan mi" },
    { time: 35, text: "Mofe ki okan mi bale" },
    { time: 40, text: "F'oyin a'tadun s'aiye me" },
    { time: 50, text: "There are many things that I can do" },
    { time: 55, text: "Even tho I should not" },
    { time: 60, text: "B'ota mi tan Candle" },
    { time: 65, text: "Ogun orun mu won" },
    { time: 70, text: "There are very little" },
    { time: 75, text: "things I cannot handle" },
    { time: 80, text: "life is like a movie" },
    { time: 85, text: "mio ja taekwondo mo o" },
    { time: 90, text: "I just wanna chill with Jollof & malt" },
    { time: 95, text: "Focus on myself make some money and more" },
    { time: 100, text: "Focus on myself make some money and more" },
    { time: 110, text: "Olorun mi Elededa mi" },
    { time: 115, text: "Wafi Isinmi f'okan mi" },
    { time: 120, text: "Mofe ki okan mi bale" },
    { time: 125, text: "F'oyin a'tadun s'aiye me" },
    { time: 130, text: "Olorun mi Elededa mi" },
    { time: 135, text: "Wafi Isinmi f'okan mi" },
    { time: 140, text: "Mofe ki okan mi bale" },
    { time: 145, text: "F'oyin a'tadun s'aiye me" },
    { time: 155, text: "I maintain it - closure is overrated" },
    { time: 160, text: "Life gets real complexed without the basics" },
    { time: 165, text: "A piece of my mind isn't peace of mind" },
    { time: 170, text: "Now I get more break downs than work payslips" },
    { time: 175, text: "I'm like maybe I'm just not the 'marrying type'" },
    { time: 180, text: "Cuz i'm losing my top like I'm looking for airpod battery life" },
    { time: 185, text: "Knowing rights isn't knowing your right" },
    { time: 190, text: "put the rest in His rest thank Jesus for bringing the light" },
    { time: 200, text: "" }
  ],
  10: [ // Angeli
    { time: 5, text: "Awelewa, you do me nice" },
    { time: 10, text: "When I dey with you it feels like I'm in Paradise" },
    { time: 15, text: "The way you smile, you look nice" },
    { time: 20, text: "Future is so bright I see it in your eyes" },
    { time: 25, text: "We can fly on a trip, anywhere you wanna be" },
    { time: 30, text: "She's a gem you can't replace her & nobody's ever ever gonna take her place" },
    { time: 40, text: "She so special, she's so loyal, she is everything I want in a woman" },
    { time: 45, text: "She's a rider, & a fighter, she is everything I want in a woman" },
    { time: 50, text: "She's so gorgeous, sweet & scrumptious, she is everything I want in a woman" },
    { time: 55, text: "She's my lover, & I like her, she is everything I want in a woman" },
    { time: 65, text: "She be my Angeli o (girly o)" },
    { time: 70, text: "She be my Angeli o (girly o)" },
    { time: 75, text: "She give me peace of mind o eh, peace of mind o" },
    { time: 80, text: "She give me peace of mind o eh, peace of mind o" },
    { time: 90, text: "" }
  ],
  11: [ // Alkebulan Outro
    { time: 5, text: "Alkebulan!!!" },
    { time: 10, text: "Mother of all, your heart beats in our veins!" },
    { time: 15, text: "Golden rivers, green roots, through time, your strength remains" },
    { time: 25, text: "From ancestors' love, their power flows in you" },
    { time: 30, text: "So brave, so bright, there's nothing you can't do" },
    { time: 40, text: "You are the earth's pulse, the mother's pride" },
    { time: 45, text: "carrying centuries of strength in your stride!" },
    { time: 55, text: "Stand tall, for your fore bearer's eyes are upon you" },
    { time: 60, text: "cheering from the stars!" },
    { time: 65, text: "Your power is boundless, your legacy eternal" },
    { time: 70, text: "your throne is divine, seize it, claim it, own it!" },
    { time: 80, text: "The world trembles at the greatness within you!" },
    { time: 90, text: "Now riiiiiise," },
    { time: 95, text: "let your story shake the skies!" },
    { time: 105, text: "" }
  ]
};
