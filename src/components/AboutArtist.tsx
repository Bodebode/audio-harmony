        ...
        <CardContent className="p-6 relative z-10">
          ...
          <div className="space-y-4 text-[#F2FCE2]">
            <p className="leading-relaxed">
              Welcome to the musical journey of Alkebulan. This artist brings a unique blend of contemporary sounds 
              and traditional influences, creating an immersive audio experience that transcends boundaries.
            </p>
